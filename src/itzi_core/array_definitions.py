...
class ArrayDefinition:
    ...
    category: tuple[ArrayCategory, ...]  # Array category
...
_INTERNAL_ARRAY_DEFINITIONS = [
    ArrayDefinition(
        ...
        description="Applied infiltration rate after the combined water-removal cap.",
        unit="m s-1",
        cf_unit="",
        var_loc="face",
    ),
    ...
    ArrayDefinition(
        key="old_discharge_east",
        csdms_name="land_surface_water_flow__x_component_of_z_integral_of_velocity",
        cf_name="",
        category=(ArrayCategory.INTERNAL,),
        description="Water unit-width discharge at eastern cell edge (previous timestep).",
        unit="m2 s-1",
        cf_unit="",
        var_loc="edge",
    ),
    ArrayDefinition(
        key="old_discharge_south",
        csdms_name="land_surface_water_flow__y_component_of_z_integral_of_velocity",
        cf_name="",
        category=(ArrayCategory.INTERNAL,),
        description="Water unit-width discharge at southern cell edge (previous timestep).",
        unit="m2 s-1",
        cf_unit="",
        var_loc="edge",
    ),
    ArrayDefinition(
        key="new_discharge_east",
        csdms_name="land_surface_water_flow__x_component_of_z_integral_of_velocity",
        cf_name="",
        category=(ArrayCategory.INTERNAL,),
        description="Water unit-width discharge at eastern cell edge.",
        unit="m2 s-1",
        cf_unit="",
        var_loc="edge",
    ),
    ArrayDefinition(
        key="new_discharge_south",
        csdms_name="land_surface_water_flow__y_component_of_z_integral_of_velocity",
        cf_name="",
        category=(ArrayCategory.INTERNAL,),
        description="Water unit-width discharge at southern cell edge.",
        unit="m2 s-1",
        cf_unit="",
        var_loc="edge",
    ),
    ...
    ArrayDefinition(
        ...
        cf_name="",
        category=(ArrayCategory.INTERNAL,),
        description="Applied user-loss rate after the combined water-removal cap.",
        unit="m s-1",
        cf_unit="",
        var_loc="face",
    ),
    ArrayDefinition(
        ...
        cf_name="",
        category=(ArrayCategory.INTERNAL,),
        description="Sum of inflow, drainage_inflow, and effective_precipitation",
        unit="m s-1",
        cf_unit="",
        var_loc="face",
    ),
...
_ACCUM_ARRAY_DEFINITIONS = [
    ...
    ArrayDefinition(
        ...
        cf_name="",
        category=(ArrayCategory.ACCUMULATION,),
        description="Reporting-interval depth removed by applied infiltration.",
        unit="m",
        cf_unit="",
        var_loc="face",
    ...
    ArrayDefinition(
        ...
        cf_name="",
        category=(ArrayCategory.ACCUMULATION,),
        description="Reporting-interval depth removed by applied user losses.",
        unit="m",
        cf_unit="",
        var_loc="face",
