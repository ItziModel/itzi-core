...
_INTERNAL_ARRAY_DEFINITIONS = [
    ...
    ArrayDefinition(
        ...
        cf_name="",
        category=(ArrayCategory.INTERNAL,),
        description="Committed water unit-width discharge at eastern cell edge.",
        unit="m2 s-1",
        cf_unit="",
        var_loc="edge",
    ),
    ArrayDefinition(
        ...
        cf_name="",
        category=(ArrayCategory.INTERNAL,),
        description="Committed water unit-width discharge at southern cell edge.",
        unit="m2 s-1",
        cf_unit="",
        var_loc="edge",
    ),
    ArrayDefinition(
        key="discharge_east_work",
        csdms_name="land_surface_water_flow__x_component_of_z_integral_of_velocity",
        cf_name="",
        category=(ArrayCategory.INTERNAL,),
        description="Solver workspace for water unit-width discharge at eastern cell edge.",
        unit="m2 s-1",
        cf_unit="",
        var_loc="edge",
    ),
    ArrayDefinition(
        key="discharge_south_work",
        csdms_name="land_surface_water_flow__y_component_of_z_integral_of_velocity",
        cf_name="",
        category=(ArrayCategory.INTERNAL,),
        description="Solver workspace for water unit-width discharge at southern cell edge.",
        unit="m2 s-1",
        cf_unit="",
        var_loc="edge",
    ),
